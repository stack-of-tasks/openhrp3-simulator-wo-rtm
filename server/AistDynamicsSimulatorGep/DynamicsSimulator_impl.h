...
*/
#ifndef OPENHRPGEP_DYNAMICS_SIMULATOR_IMPL_H_INCLUDED
#define OPENHRPGEP_DYNAMICS_SIMULATOR_IMPL_H_INCLUDED


#include <hrpGepCorba/ORBwrap.h>
#include <hrpGepCorba/ModelLoader.hh>
#include <hrpGepCorba/CollisionDetector.hh>
#include <hrpGepCorba/DynamicsSimulator.hh>

#include <hrpGepModel/World.h>
#include <hrpGepModel/ConstraintForceSolver.h>
#include <hrpGepUtil/TimeMeasure.h>
    ...
    virtual public PortableServer::RefCountServantBase
{
    ...
    hrpGep::World<hrpGep::ConstraintForceSolver> world;
