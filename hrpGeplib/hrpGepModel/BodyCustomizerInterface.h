...
#ifndef HRPGEPMODEL_BODY_CUSTOMIZER_INTERFACE_H_INCLUDED
#define HRPGEPMODEL_BODY_CUSTOMIZER_INTERFACE_H_INCLUDED

#include "Config.h"
#include <string>
#include <hrpGepUtil/EigenTypes.h>
...
namespace hrpGep {
    ...
    */
    ...
    HRPGEPMODEL_API int loadBodyCustomizers(const std::string pathString, BodyInterface* bodyInterface);
    HRPGEPMODEL_API int loadBodyCustomizers(const std::string pathString);
    HRPGEPMODEL_API int loadBodyCustomizers(BodyInterface* bodyInterface);
    HRPGEPMODEL_API int loadBodyCustomizers();
    
    HRPGEPMODEL_API BodyCustomizerInterface* findBodyCustomizer(std::string modelName);
