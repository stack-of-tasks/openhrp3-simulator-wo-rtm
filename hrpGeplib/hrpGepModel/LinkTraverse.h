...
#ifndef HRPGEPMODEL_LINK_TRAVERSE_H_INCLUDED
#define HRPGEPMODEL_LINK_TRAVERSE_H_INCLUDED

#include <vector>
#include <ostream>
#include <hrpGepUtil/config.h>
#include "Config.h"
...
namespace hrpGep {
    ...
    class HRPGEPMODEL_API LinkTraverse
    {
      public:
        LinkTraverse();
...
HRPGEPMODEL_API std::ostream& operator<<(std::ostream& os, hrpGep::LinkTraverse& traverse);
