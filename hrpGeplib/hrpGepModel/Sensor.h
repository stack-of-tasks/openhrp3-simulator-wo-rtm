...
#ifndef HRPGEPMODEL_SENSOR_H_INCLUDED
#define HRPGEPMODEL_SENSOR_H_INCLUDED
...
namespace hrpGep {
    ...
    class HRPGEPMODEL_API ForceSensor : public Sensor
    {
      public:
    ...
    class HRPGEPMODEL_API RateGyroSensor : public Sensor
    {
      public:
    ...
    class HRPGEPMODEL_API AccelSensor : public Sensor
    {
      public:
    ...
    class HRPGEPMODEL_API RangeSensor : public Sensor
    {
      public:
...
#undef near
    ...
    class HRPGEPMODEL_API VisionSensor : public Sensor
    {
      public:
