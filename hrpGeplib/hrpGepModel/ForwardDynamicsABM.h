...
#ifndef OPENHRPGEP_FORWARD_DYNAMICS_ABM_H_INCLUDED
#define OPENHRPGEP_FORWARD_DYNAMICS_ABM_H_INCLUDED
...
namespace hrpGep
{
    ...
    */
    class HRPGEPMODEL_API ForwardDynamicsABM : public ForwardDynamics {
