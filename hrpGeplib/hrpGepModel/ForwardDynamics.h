...
#ifndef OPENHRPGEP_FORWARD_DYNAMICS_H_INCLUDED
#define OPENHRPGEP_FORWARD_DYNAMICS_H_INCLUDED
...
namespace hrpGep
{
    ...
    */
    class HRPGEPMODEL_API ForwardDynamics {
    ...
    protected:
        ...
        double jointFriction(Link* link,
                             double clmb_threshold=0.1,
                             unsigned int poly=3) const;
        BodyPtr body;
        Vector3 g;
        double timeStep;
        bool sensorsEnabled;
