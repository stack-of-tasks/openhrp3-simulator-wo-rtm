...
#ifndef OPENHRPGEP_FORWARD_DYNAMICS_MM_H_INCLUDED
#define OPENHRPGEP_FORWARD_DYNAMICS_MM_H_INCLUDED
...
namespace hrpGep
{
	...
	*/
    class HRPGEPMODEL_API ForwardDynamicsMM : public ForwardDynamics {
