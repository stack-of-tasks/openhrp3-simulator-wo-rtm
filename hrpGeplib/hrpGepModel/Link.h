...
#ifndef HRPGEPMODEL_LINK_H_INCLUDED
#define HRPGEPMODEL_LINK_H_INCLUDED
...
HRPGEPMODEL_API std::ostream& operator<<(std::ostream &out, hrpGep::Link& link);
...
namespace hrpGep {
    ...
    class HRPGEPMODEL_API Link {
      ...
      private:
        ...
        friend std::ostream& ::operator<<(std::ostream &out, hrpGep::Link& link);
