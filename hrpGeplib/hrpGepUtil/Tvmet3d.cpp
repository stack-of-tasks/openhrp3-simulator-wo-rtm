...
void hrpGep::calcRodrigues(Matrix33& out_R, const Vector3& axis, double q)
{
...
Vector3 hrpGep::omegaFromRot(const Matrix33& r)
{
...
Vector3 hrpGep::rpyFromRot(const Matrix33& m)
{
...
void hrpGep::calcRotFromRpy(Matrix33& out_R, double r, double p, double y)
{
...
void hrpGep::calcInverse(Matrix33& inv, const Matrix33& m)
{
...
bool hrpGep::isOrthogonalMatrix(Matrix33& m){
