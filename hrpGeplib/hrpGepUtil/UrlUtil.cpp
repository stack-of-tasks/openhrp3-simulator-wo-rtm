...
/*!  
  ...
  @endif
*/
string hrpGep::deleteURLScheme(string url)
{
...
/*!  
  ...
  @endif
*/
void hrpGep::getPathFromUrl(string& refUrl, const string& rootDir, string srcUrl)
{
...
/*!  
  ...
  @endif
*/
bool hrpGep::isFileProtocol(const string& ref)
{
    bool ret = false;
