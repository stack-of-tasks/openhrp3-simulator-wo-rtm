...
OnlineViewer_var hrpGep::getOnlineViewer(CosNaming::NamingContext_var cxt)
{  
...
OnlineViewer_var hrpGep::getOnlineViewer(CORBA_ORB_var orb)
{
...
OnlineViewer_var hrpGep::getOnlineViewer(int argc, char **argv)
{
